...
def run_baseline_test_ins(X_train, y_train, X_test, y_test, output_dir, args):
  print("")
...
def run_complex_test_ins(X_train, y_train, X_test, y_test, output_dir, metric, modeltype, args, maximize=True):
  print("")
...
def main():
  ...
  if args.test == 'baseline':
    if args.dataset == "ins":
      run_baseline_test_ins(X_train, y_train, X_test, y_test, output_dir, args)
    else:
    ...
    if args.dataset == "cancer":
      ...
      if metric == "mae":
        run_complex_test_ins(X_train, y_train, X_test, y_test, output_dir, mae, LinearRegression, args, maximize=False)
      elif metric == "mse":
        run_complex_test_ins(X_train, y_train, X_test, y_test, output_dir, mse, LinearRegression, args, maximize=False)
      elif metric == "rmse":
        run_complex_test_ins(X_train, y_train, X_test, y_test, output_dir, rmse, LinearRegression, args, maximize=False)
      elif metric == "r_squared":
        run_complex_test_ins(X_train, y_train, X_test, y_test, output_dir, r_squared, LinearRegression, args)
      else:
        run_complex_test_ins(X_train, y_train, X_test, y_test, output_dir, mae, LinearRegression, args, maximize=False)
    else:
        print("")
